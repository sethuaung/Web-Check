...
const About = (): JSX.Element => {
  return (
    ...
    <AboutContainer>
      <Nav>
        <HeaderLinkContainer>
          <a href="https://github.com/sethuaung/web-check"><Button>View on GitHub</Button></a>
        </HeaderLinkContainer>
      </Nav>
      ...
      <Section>
        ...
        <hr />
        <p>
          Web-Check is developed and maintained by <a href="https://felixent.net">Felixent</a>.
          It's licensed under the <a href="https://github.com/sethuaung/web-check/blob/master/LICENSE">MIT license</a>,
          and is completely free to use, modify and distribute in both personal and commercial settings.<br />
          Source code and self-hosting docs are available on <a href="https://github.com/sethuaung/web-check">GitHub</a>.
          If you've found this service useful, consider <a href="https://github.com/sponsors/sethuaung">sponsoring me</a> from $1/month,
      ...
      <Section>
        ...
        <a href="https://app.netlify.com/start/deploy?repository=https://github.com/sethuaung/web-check">
        ...
        <p>
          ...
          GitHub repository - <a href="https://github.com/sethuaung/web-check#readme">github.com/sethuaung/web-check</a>
        </p>
...
- `REACT_APP_API_ENDPOINT` (e.g. `/api`) - The endpoint for the API (can be local or remote)</p> */}
      ...
      <Heading as="h3" size="small" color={colors.primary}>License</Heading>
        <b>
          <a href="https://github.com/sethuaung/web-check">Web-Check</a> is distributed under the MIT license,
          © <a href="https://felixent.net">Felixent</a> { new Date().getFullYear()}
        </b>
        <br />
