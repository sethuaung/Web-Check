...
const About = (): JSX.Element => {
  ...
  return (
    ...
    <AboutContainer>
      <Nav>
        <HeaderLinkContainer>
          <a target="_blank" rel="noreferrer" href="https://github.com/sethuaung/Web-Check"><Button>View on GitHub</Button></a>
        </HeaderLinkContainer>
      </Nav>
      ...
      <Section>
        ...
        <hr />
        <p>
          Web-Check is developed and maintained by <a target="_blank" rel="noreferrer" href="https://felixentwebcheck.netlify.app/">FELIXENT</a>.
          ...
          If you've found this service useful, consider <a target="_blank" rel="noreferrer" href="https://github.com/sponsors/sethuaung">sponsoring me</a> from $1/month,
      ...
      <Section>
        ...
        <a target="_blank" rel="noreferrer" href="https://app.netlify.com/start/deploy?repository=https://github.com/sethuaung/Web-Check">
        ...
        <a target="_blank" rel="noreferrer" href="https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Flissy93%2Fweb-check&project-name=web-check&repository-name=web-check-fork&demo-title=Web-Check%20Demo&demo-description=Check%20out%20felixentwebcheck.netlify.app%20to%20see%20a%20live%20demo%20of%20this%20application%20running.&demo-url=https%3A%2F%2Ffelixentwebcheck.netlify.app&demo-image=https%3A%2F%2Fraw.githubusercontent.com%2FLissy93%2Fweb-check%2Fmaster%2F.github%2Fscreenshots%2Fweb-check-screenshot10.png">
          <img src="https://vercel.com/button" alt="Deploy with Vercel" />
        </a>

        <Heading as="h3" size="small" color={colors.primary}>Option #3 - Docker</Heading>
        <p>
        A Docker container is published to <a target="_blank" rel="noreferrer" href="https://hub.docker.com/r/sethuaung/Web-Check">DockerHub</a>
        <br />
        Run this command, then open <code>localhost:3000</code>
        <pre>docker run -p 3000:3000 sethuaung/Web-Check</pre>
        </p>

        <Heading as="h3" size="small" color={colors.primary}>Option #4 - Manual</Heading>
        <pre>
        git clone https://github.com/sethuaung/Web-Check.git<br />
        ...
        <p>
          ...
          GitHub repository - <a target="_blank" rel="noreferrer" href="https://github.com/sethuaung/Web-Check#readme">github.com/sethuaung/Web-Check</a>
        </p>
      ...
      <Heading as="h3" size="small" color={colors.primary}>License</Heading>
        <b>
          ...
          © <a target="_blank" rel="noreferrer" href="https://felixentwebcheck.netlify.app/">FELIXENT</a> { new Date().getFullYear()}
        </b>
        <br />
