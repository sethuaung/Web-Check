  ...
  return (
    <HomeContainer>
      ...
      <SiteFeaturesWrapper>
        ...
        <div className="links">
          <a target="_blank" rel="noreferrer" href="https://github.com/sethuaung/Web-Check" title="Check out the source code and documentation on GitHub, and get support or contribute">
            <Button>View on GitHub</Button>
          </a>
          <a target="_blank" rel="noreferrer" href="https://app.netlify.com/start/deploy?repository=https://github.com/sethuaung/Web-Check" title="Deploy your own private or public instance of Web-Check to Netlify">
