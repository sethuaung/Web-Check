...
const Results = (props: { address?: string } ): JSX.Element => {
  ...
  return (
    <ResultsOuter>
      ...
      {/* { address?.includes(window?.location?.hostname || 'felixentwebcheck.netlify.app') && <SelfScanMsg />} */}
      ...
      <FilterButtons>{ showFilters ? <>
        ...
        <span className="toggle-filters" onClick={() => setShowFilters(false)}>Hide</span>
          ...
          <div className="control-options">
            ...
            <a target="_blank" rel="noreferrer" href="https://github.com/sethuaung/Web-Check"><span className="toggle-filters">View GitHub</span></a>
          </div>
      ) }
      </FilterButtons>
      <ResultsContent>
